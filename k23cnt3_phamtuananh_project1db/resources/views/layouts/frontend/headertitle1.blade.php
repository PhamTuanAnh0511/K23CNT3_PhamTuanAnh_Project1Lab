...
<body class="bg-gradient-to-r from-black-500 to-brown-500 text-white">
  <div class="header bg-gradient-to-r from-brown-500 to-black-500">

    <div class="container mx-auto">
      <!-- Top Navigation -->
      <div class="flex justify-between items-center py-2 text-sm">
        <div>
          <a class="mr-4 hover:underline" href="{{route('ptauser.home1')}}">Trang Chủ</a>
        ...
        <div class="flex items-center space-x-4">
          ...
          <a class="hover:underline" href="pta-user/support">
          ...
          @if(Session::has('username1'))
              <a class="hover:underline" href="{{ route('ptauser.home') }}">
                  Đăng Xuất
              </a>
          @else
              <a class="hover:underline" href="{{ route('ptauser.login') }}">
                  Đăng Nhập
              </a>
          @endif
        </div>
      ...
      <div class="flex items-center py-4">
        <div class="flex items-center">
          <a href="{{route('ptauser.home1')}}"><img alt=" logo" class="mr-2" height="40" src="/storage/img/san_pham/logoA.png" width="100"/></a>
        </div>
        <div class="flex-grow mx-4">
          <form action="{{route('ptauser.search1')}}" method="GET" class="flex">
