...
<body class="bg-gradient-to-r from-brown-300 to-brown-400 text-white">

  <div class="header bg-gradient-to-r from-brown-400 to-black-400">
    <div class="container mx-auto">
      <!-- Top Navigation -->
      <div class="flex justify-between items-center py-2 text-sm">
        <div>

          <a class="mr-4 hover:underline" href="{{route('ptauser.home')}}">Trang Chủ</a>
        ...
        <div>
          ...
          <a class="mr-4 hover:underline" href="pta-user/support">
              <i class="fas fa-question-circle"></i> Hỗ Trợ
            </a>
          <a class="mr-4 hover:underline" href="#"><i class="fas fa-globe"></i> Tiếng Việt</a>
          <a class="mr-4 hover:underline" href="/pta-user/signup">Đăng Ký</a>
          <a class="hover:underline" href="{{route('ptauser.login')}}">Đăng Nhập</a>
        </div>
      </div>
      <!-- Main Navigation -->
      <div class="flex items-center py-4">
        <div class="flex items-center">
          <a href="{{route('ptauser.home')}}"><img alt=" logo" class="mr-2" height="40" src="/storage/img/san_pham/logoA.png" width="100"/></a>
        </div>
        <div class="flex-grow mx-4">
          <form action="{{route('ptauser.search')}}" method="GET" class="flex">
